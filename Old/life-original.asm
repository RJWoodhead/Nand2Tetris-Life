...
//
// @Mult routine could be replaced by a x66 table, my bad. There are some other optimizations I was
// too lazy to do because they are in the UI part that spends 99.9% of its time waiting for the
// user to get around to pressing a key. I spent my time optimizing the life generation update code.
//
// Keyboard commands:
//
